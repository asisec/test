...
<div class="container mt-3 mb-3">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
            <a href="{{ $top1->url }}"><img src="{{ asset($top1->image) }}" alt="{{ $top1->name ?? __('Textile Banner') }}" style="width: 100%; height: 120px; object-fit: cover; border-radius: 8px;" class="shadow-sm"></a>
        </div>
        @endif
        @if($top2)
        <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
            <a href="{{ $top2->url }}"><img src="{{ asset($top2->image) }}" alt="{{ $top2->name ?? __('Textile Banner') }}" style="width: 100%; height: 120px; object-fit: cover; border-radius: 8px;" class="shadow-sm"></a>
        </div>
        @endif
    </div>
</div>
...
<div class="container mt-3 mb-3">
    <div class="row">
        @if($bottom1)
        <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
            <a href="{{ $bottom1->url }}"><img src="{{ asset($bottom1->image) }}" alt="{{ $bottom1->name ?? __('Textile Banner') }}" style="width: 100%; height: 120px; object-fit: cover; border-radius: 8px;" class="shadow-sm"></a>
        </div>
        @endif
        @if($bottom2)
        <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
            <a href="{{ $bottom2->url }}"><img src="{{ asset($bottom2->image) }}" alt="{{ $bottom2->name ?? __('Textile Banner') }}" style="width: 100%; height: 120px; object-fit: cover; border-radius: 8px;" class="shadow-sm"></a>
        </div>
        @endif
    </div>
</div>
