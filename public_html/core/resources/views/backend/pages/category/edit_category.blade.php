                 ...
                 <form action="{{route('admin.category.edit',$category->id)}}" method="post" enctype="multipart/form-data" id="edit_category_form">
                    ...
                    <div class="form__input__flex">
                        <div class="form__input__single">
                            <label for="home_header_order" class="form__input__single__label">{{__('Home Category Order')}}</label>
                            <input type="number" min="0" max="100" class="form__control radius-5" name="home_header_order" id="home_header_order" value="{{$category->home_header_order}}" placeholder="{{__('Home Category Order')}}">
                        </div>
