                        ...
                        <div class="row g-4">
                                                    ...
                                                    <a href="{{route('about.user.profile', optional($listing->user)->username)}}" target="_blank">
                                                        <div class="customer__details__author__thumb">
                                                            <div class="seller-img">
                                                               {!! render_image_markup_by_attachment_id($listing->user->image ?? '/assets/uploads/no-image.png', '', 'thumb') !!}
                                                            </div>
                                                        </div>
                                                    </a>
                                                </div>
                            ...
                            <div class="col-xxl-4 col-lg-4">
                                <div class="editProduct__contents">
                                    <form action="{{ route('admin.listings.updateRead', ['id' => $listing->id]) }}" method="post">
                                        @csrf
                                        <input name="phone_shows_only_premium" value="{{ +!$listing->phone_shows_only_premium }}" hidden>
                                    
                                        <button class="btn btn-primary btn-md" id="bulk_delete_btn">
                                            <b>@if($listing->phone_shows_only_premium === 1) {{ __('Show') }} @else {{ __('Hide') }} @endif</b> {{ __('Phone Number To Non-Premium Users') }}
                                        </button>
                                    </form>
                                    <div class="editProduct__contents__category mt-3">
                                    ...
                                    <div class="editProduct__contents__brand mt-3">
                                        <div class="editProduct__contents__sku__para d-flex gap-2">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <span>{{$listing->country->country ?? '-'}}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="editProduct__contents__brand mt-3">
