                ...
                <div class="dashboard__card bg__white padding-20 radius-10">
                    <h2 class="dashboard__card__header__title mb-3">{{__('Listing Details Page Settings')}}</h2>
                     ...
                     <div class="form__input__single">
                      ...
                      <div class="form__input__single">
                            <label class="form__input__single__label">{{__('Attributes Section Title')}}</label>
                            <input class="form--control" name="listing_attribute_section_title" value="{{ get_static_option('listing_attribute_section_title') }}"  placeholder="{{ __('Attributes Section Title') }}">
                        </div>
                </div>
            </div>
            <div class="col-xl-6 col-lg-6 mt-4">
