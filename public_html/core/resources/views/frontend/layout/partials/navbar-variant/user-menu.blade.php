            ...
            <ul class="ac-list">
                ...
                <li class="list">
                    <a class="list-title" href="{{ route('user.all.listing') }}">
                        ...
                        {{ deepl_translate(__('All Listing')) }}
                    </a>
                </li>
                ...
                <!--Support Ticket -->
                  <li class="list">
                    <a href="{{ route('user.ticket') }}" class="list-title">
                      ...
                      {{ deepl_translate(__('Support tickets')) }}
                    </a>
                  </li>
                ...
                @if(membershipModuleExistsAndEnable('Membership'))
                    <li class="list">
                        <a href="{{ route('user.enquiries.all') }}" class="list-title">
                            ...
                            <span> {{ deepl_translate(__('Enquiries')) }}</span>
                        </a>
                    </li>
                @endif
            @endif
...
<li class="single" style="margin-left: 20px !important;">
    <div class="dropdown">
        ...
        >
            <img
            src="https://flagcdn.com/24x18/{{ get_language_flag_code($activeLanguage) }}.png"
            width="24"
        ...
        <ul class="dropdown-menu dropdown-menu-end" style="margin-top: 1.25rem;">
            ...
            @foreach ($otherLangs as $language)
                <li class="dropdown-item">
                    <a class="d-flex gap-2 align-items-center text-truncate" href="?lang={{$language->slug ?? ''}}">
                        <img
                        src="https://flagcdn.com/20x15/{{ get_language_flag_code($language) }}.png"
                        width="20"
                        alt="{{$language->name}}">
                        <span class="d-inline-block text-truncate">
                            {{$language->name}}
