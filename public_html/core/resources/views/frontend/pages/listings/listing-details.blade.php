            ...
            <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-8 col-md-8 ">
                    ...
                    <div class="seller-part mt-3 d-md-none">
                        <x-listings.user-listing-phone-for-responsive :listing="$listing" :maskedPhoneNumber="$masked_phone_number" :userHasMembership="$user_has_membership"/>
                    ...
                    <div class="seller-part">
                        <!--user info -->
                         <div class="d-none d-md-block">
                            <x-listings.user-listing-phone :listing="$listing" :maskedPhoneNumber="$masked_phone_number" :userHasMembership="$user_has_membership"/>
                            <x-listings.listing-details-page-user-info :listing="$listing" :userTotalListings="$user_total_listings"/>
                         </div>
                        <!--Adds left-->
