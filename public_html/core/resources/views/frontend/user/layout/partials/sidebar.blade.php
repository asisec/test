<div class="sidebar-menu-wraper box-shadow1">
    <a href="{{ route('user.dashboard') }}" class="menu-item @if(request()->routeIs('user.dashboard')) active @endif">
        ...
        <span class="ms-2">{{ deepl_translate(__('Dashboard')) }}</span>
    </a>
    ...
    <a href="{{ route('user.all.listing') }}" class="menu-item @if(request()->is('user/listing/*')) active @endif">
        ...
        <span class="ms-2">{{ deepl_translate(__('My Listings')) }}</span>
    </a>
    ...
    @if(moduleExists('Membership'))
        @if(membershipModuleExistsAndEnable('Membership'))
            <a href="{{ route('user.membership.all') }}" class="menu-item @if (request()->routeIs('user.membership.all')) active @endif">
                ...
                <span class="ms-2"> {{ deepl_translate(__('Membership')) }}</span>
            </a>
        @endif
     @endif
    ...
    <a href="{{ route('user.wallet.history') }}" class="menu-item @if (request()->routeIs('user.wallet.history')) active @endif">
        ...
        <span class="ms-2"> {{ deepl_translate(__('Wallet')) }}</span>
    </a>
    @endif
    ...
    @if(moduleExists('Chat'))
        ...
        @if(!empty($member_find))
            <a  href="{{ route('member.live.chat') }}" class="menu-item @if (request()->routeIs('user.live.chat')) active @endif">
                ...
                <span class="ms-2"> {{ deepl_translate(__('Chat')) }}</span>
            </a>
        @else
  ...
  <!--Support Ticket -->
    <a href="{{ route('user.ticket') }}" class="menu-item @if (request()->is('user/support-ticket/ticket')) active @endif">
        ...
        <span class="ms-2">  {{ deepl_translate(__('Support tickets')) }} </span>
    </a>
    ...
    <a href="{{ route('user.listing.favorite.all') }}" class="menu-item  @if(request()->is('user/favorite/listing*')) active @endif">
        ...
        <span class="ms-2">   {{ deepl_translate(__('Favourite')) }}</span>
    </a>
    ...
    @if(moduleExists('Membership'))
        @if(membershipModuleExistsAndEnable('Membership'))
            <a href="{{ route('user.enquiries.all') }}" class="menu-item @if (request()->routeIs('user.enquiries.all')) active @endif">
                ...
                <span class="ms-2"> {{ deepl_translate(__('Enquiries')) }}</span>
            </a>
        @endif
    @endif
    ...
    <a href="{{ route('user.profile') }}" class="menu-item @if(request()->is('user/profile/settings*')) active @endif">
        ...
        <span class="ms-2"> {{ deepl_translate(__('Profile')) }}</span>
    </a>
    <a href="{{ route('user.account.settings') }}" class="menu-item @if(request()->is('user/account-settings*')) active @endif">
        ...
        <span class="ms-2">   {{ deepl_translate(__('Settings')) }}</span>
    </a>
    ...
    <a href="{{ route('user.verification.center') }}" class="menu-item @if(request()->is('user/verification-center*')) active @endif">
        ...
        <span class="ms-2"> {{ deepl_translate(__('Verification Center')) }}</span>
    </a>
</div>
