...
@section('site_title')
    {{ deepl_translate(__('Add Listing')) }}
@endsection
@section('style')
    <x-media.css/>
    <x-summernote.css/>
                    ...
                    <div class="col-lg-12 mt-1">
                        <div class="alert alert-warning d-flex justify-content-between">
                            <a href="{{ route('user.membership.all') }}">
                             {{ deepl_translate(__('Your membership package listing limit has been reached. Please consider upgrading your membership to continue listing:')) }}
                            </a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="col-lg-8">
                                            <div class="post-add-wraper">
                                                <div class="item-name box-shadow1 p-24">
                                                    ...
                                                    <input type="text" name="title" id="title" value="{{ old('title') }}" class="input-filed w-100" placeholder="{{ deepl_translate(__('Item Name')) }}">
                                                        ...
                                                        <div class="row g-3 mt-3">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="item-subcatagory-wraper">
                                                                    <label for="item-subcatagory">{{deepl_translate(__('Sub Category'))}}</label>
                                                                    <select  name="sub_category_id" id="subcategory" class="subcategory select2_activation">
                                                                        <option value="">{{deepl_translate(__('Select Sub Category'))}}</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <div class="item-subcatagory-wraper">
                                                                    <label for="item-subcatagory">{{deepl_translate(__('Child Category'))}} </label>
                                                                    <select  name="child_category_id" id="child_category" class="select2_activation">
                                                                        <option value="">{{deepl_translate(__('Select Child Category'))}}</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="description box-shadow1 p-24 mt-4">
                                                    ...
                                                    <textarea name="description" id="description" rows="6" class="input-filed w-100 textarea--form summernote" placeholder="{{deepl_translate(__('Enter a Description'))}}">{{ old('description') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="right-sidebar">
                                                <div class="box-shadow1 price p-24">
                                                    <div class="price-wraper">
                                                        ...
                                                        <input type="number" name="price" id="price" value="{{ old('price') }}" class="input-filed w-100 mb-3" placeholder="{{deepl_translate(__('0.00'))}}">
                                                ...
                                                <div class="box-shadow1 hode-phone-number p-24 mt-3">
                                                    ...
                                                    <div class="input-group mt-3">
                                                        ...
                                                        <input class="input-filed w-100" type="tel" name="phone" value="{{old('phone')}}" id="phone" placeholder="{{deepl_translate(__('Type Phone'))}}">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="address box-shadow1 p-24">
                                                ...
                                                <div class="address-wraper">
                                                    <div class="row g-3">
                                                        <div class="col-sm-4">
                                                            <div class="country">
                                                                <label for="country">{{ deepl_translate(__('Select Your Country')) }}</label>
                                                            ...
                                                            <div class="country">
                                                                <label for="country">{{ deepl_translate(__('Select Your State')) }}</label>
                                                ...
                                                <div class="address-text mt-3">
                                                    ...
                                                    <input type="text" class="w-100 input-filed" name="address" id="user_address" value="{{ old('address') }}" placeholder="{{deepl_translate(__('Address'))}}">
                                                </div>
                                            </div>
                                            <div class="video box-shadow1 p-24 mt-3 mb-3">
                                                <label for="vedio-link">{{ deepl_translate(__('Video Url')) }}</label>
                                                <input type="text"  class="input-filed w-100" name="video_url" id="video_url" value="{{ old('video_url') }}" placeholder="{{deepl_translate(__('youtube url'))}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3">
                                            <div class="right-sidebar">
                                                ...
                                                <!--Guest post section -->
                                                <div class="box-shadow1 hode-phone-number p-24 mt-3">
                                                    <label>{{ get_static_option('guest_add_listing_info_section_title') ?? deepl_translate(__('User Information')) }}</label>
                                                    <div class="mt-3">
                                                        <label for="guest_first_name" class="infoTitle">{{ deepl_translate(__('First Name')) }} <span class="text-danger">*</span> </label>
                                                        <input type="text" class="input-filed w-100" name="guest_first_name" id="guest_first_name" value="{{ old('guest_first_name') }}"  placeholder="{{deepl_translate(__('First Name'))}}">
                                                    </div>
                                                    <div class="mt-3">
                                                        <label for="guest_first_name" class="infoTitle">{{ deepl_translate(__('Last Name')) }} <span class="text-danger">*</span> </label>
                                                        <input type="text" class="input-filed w-100" name="guest_last_name" id="guest_last_name" value="{{ old('guest_last_name') }}"  placeholder="{{deepl_translate(__('Last Name'))}}">
                                                    </div>
                                                    <div class="mt-3">
                                                        <label for="guest_first_name" class="infoTitle">{{ deepl_translate(__('Email')) }} <span class="text-danger">*</span> </label>
                                                        <input type="email" class="input-filed w-100" name="guest_email" id="guest_email" value="{{ old('guest_email') }}"  placeholder="{{  deepl_translate(__('Email'))}}">
                                                    </div>
                                                    <div class="mt-3">
                                                        <label for="guest_first_name" class="infoTitle">{{ deepl_translate(__('Phone Number')) }} </label>
                                                        <input type="hidden" id="guest-country-code" name="guest_country_code">
                                                        <input type="tel" class="input-filed w-100" name="guest_phone" id="guest_phone" value="{{ old('guest_phone') }}"  placeholder="{{deepl_translate(__('Phone'))}}">
                                                    </div>
                                                    ...
                                                    <div class="feature">
                                                        <label>
                                                            ...
                                                            <span class="ms-2 title-para text-primary">{{ get_static_option('guest_registration_agreement_title') ?? deepl_translate(__('I agree that the above information is accurate and I am excited to register!')) }}</span>
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="feature">
                                                        <label class="checkWrap2 terms-conditions">
                                                            ...
                                                            <span class="checkmark mx-1"></span> {{ deepl_translate(__('I agree with the')) }}
                                                ...
                                                <div class="continue-btn mt-3">
                                                    <div class="btn-wrapper mb-10 d-flex justify-content-end gap-3">
                                                        ...
                                                        <button class="red-btn w-100 d-block" id="submitBtn" type="submit">{{deepl_translate(__('Submit Listing'))}}</button>
                                                    </div>
                                                </div>
