    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ deepl_translate(__('Background Image')) }}</h5>
            ...
            <form id="edit_profile_form" method="post">
                    ...
                    <div class="media-upload-btn-wrapper">
                        <div class="single-flex-input">
                            ...
                            <button type="button" class="btn btn-info media_upload_form_btn"
                                    ...
                                    data-modaltitle="{{deepl_translate(__('Upload Background Image'))}}"
                                    data-bs-toggle="modal"
                                    data-bs-target="#media_upload_modal">
                                {{deepl_translate(__('Upload Image'))}}
                            </button>
                         </div>
                    </div>
                    </div>
                ...
                <div class="modal-footer">
                    <div class="btn-wrapper d-flex gap-2">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{ deepl_translate(__('Close')) }}</button>
                        <button type="submit" class="cmn-btn1 popup-modal"> {{ deepl_translate(__('Update')) }} </button>
                    </div>
                </div>
            </form>
        </div>
