                    ...
                    <div class="plugin-grid">
                        ...
                        <div class="plugin-card">
                            <div class="thumb-bg-color captcha2">
                                <strong class="captcha">{{__("Google Captcha V2")}}</strong>
                            </div>
                            <p class="plugin-meta">
                                {{__("you can configure Google Captcha into the website.")}}
                            </p>
                            <div class="btn-group-wrap">
                                <a href="#"
                                   ...
                                   class="pl-btn pl_active_deactive">
                                    {{ $method("site_google_captcha_enable") == 'on' ? __("Deactivate") : __("Active") }}
                                </a>
                                <a href="#"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.integration') }}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="#">{{__("Google Captcha V2 Site Key")}}</label>
                            <input type="text"
                                   name="recaptcha_2_site_key"
                                   class="form-control"
                                   value="{{$method("recaptcha_2_site_key")}}">
                        </div>

                        <div class="form-group">
                            <label for="#">{{__("Google Captcha V2 Secret Key")}}</label>
                            <input type="text"
                                   name="recaptcha_2_secret_key"
                                   class="form-control"
                                   value="{{$method("recaptcha_2_secret_key")}}">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{__('Close')}}</button>
