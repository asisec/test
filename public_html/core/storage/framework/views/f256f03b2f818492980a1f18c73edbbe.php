                                    ...
                                    <?php $__currentLoopData = $subcategory_under_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="singleCategories categories1 wow fadeInUp" data-wow-delay="0.1s">
                                                ...
                                                <div class="categorie-text">
                                                    ...
                                                    <p> <?php echo e(__('Listing :total_listings', ['total_listings' => $sub_cat->total_listings ?? 0])); ?></p>
                                                </div>
                                        </div>
                        ...
                        <section class="featureListing mb-5 mt-5">
                            <div class="container-1440">
                                <div class="titleWithBtn d-flex justify-content-between align-items-center mb-40">
                                    <h3 class="catagory-wise-title"><?php echo e(sprintf(__('Available Listings in %s'), $category->name)); ?> </h3>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/textileforum/htdocs/textileforum.net/public_html/core/resources/views/frontend/pages/listings/category/category-wise-listings.blade.php ENDPATH**/ ?>