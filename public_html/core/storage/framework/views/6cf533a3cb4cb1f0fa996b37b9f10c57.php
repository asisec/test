<?php
    function get_language_flag_code($language){
        $specialCases = [
            'azb' => 'az',
            'ary' => 'ma',
        ];
        ...
        $flagCode = strtolower(count($codeParts) === 2 ? $codeParts[1] : $codeParts[0]);
        return $specialCases[$flagCode] ?? $flagCode;
    }

    $activeLocaleSlug = app()->getLocale();

    $activeLanguage = collect($all_language)->first(function ($language) use ($activeLocaleSlug) {
        return $language['slug'] === $activeLocaleSlug;
    });
    $otherLangs = collect($all_language)->filter(function ($language) use ($activeLocaleSlug) {
        return $language['slug'] !== $activeLocaleSlug;
    });
?>
...
<li class="single" style="margin-left: 20px !important;">
    <div class="dropdown">
        ...
        >
            <img
            src="https://flagcdn.com/24x18/<?php echo e(get_language_flag_code($activeLanguage)); ?>.png"
            width="24"
            alt="<?php echo e($activeLanguage->name); ?>">
        </a>
        <?php endif; ?>
    
        <ul class="dropdown-menu dropdown-menu-end" style="margin-top: 1.25rem;">
            <?php if($activeLanguage): ?>
            <li class="dropdown-item">
                <a class="d-flex gap-2 align-items-center">
                    ...
                    <span class="d-inline-block text-truncate">
                        <?php echo e($activeLanguage->name); ?>
            ...
            <?php $__currentLoopData = $otherLangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="dropdown-item">
                    <a class="d-flex gap-2 align-items-center text-truncate" href="?lang=<?php echo e($language->slug ?? ''); ?>">
                        <img
                        src="https://flagcdn.com/20x15/<?php echo e(get_language_flag_code($language)); ?>.png"
                        width="20"
...
<?php /**PATH /home/textileforum/htdocs/textileforum.net/public_html/core/resources/views/frontend/layout/partials/navbar-variant/user-menu.blade.php ENDPATH**/ ?>