...
Route::get('/deepl-test', function () {
    return view('frontend.deepl-test');
});

Route::post('/deepl-test', function (\Illuminate\Http\Request $request) {
    $text = $request->input('text');
    $lang = $request->input('lang', 'en');
    $translated = deepl_translate($text, $lang);
    return response()->json(['original' => $text, 'translated' => $translated]);
});
